...
class blogpedia_block_1_widget extends WP_Widget {
   function __construct() {
		parent::__construct(
			'blogpedia_block_1', esc_html_x('BLOGPEDIA Block 1 - Mag (8/12)', 'widget name', 'blogpedia'),
			array(
				'classname' => 'blogpedia-block-1-widget',
				'description' => esc_html__('BLOGPEDIA Block 1 widget posts (normal) ', 'blogpedia'),
    ...
    function form($instance) {
		...
		<div class="blogpedia-border">
			<img src="<?php echo get_template_directory_uri() . '/public/images/widget/block-1.png'; ?>" alt="" />
		</div>
        <p>
