...
class blogpedia_slider_2_widget extends WP_Widget {
   function __construct() {
		parent::__construct(
			'blogpedia_slider_2', esc_html_x('BLOGPEDIA Slider 2 - Mag (12/12)', 'widget name', 'blogpedia'),
			array(
				'classname' => 'blogpedia-slider-2-widget',
				'description' => esc_html__('BLOGPEDIA Slider 2  widget posts (3 in 1) .', 'blogpedia'),
				'customize_selective_refresh' => true
			)
		);
	}
	function widget($args, $instance) {
		$defaults = array('title' => '', 'category' => 0, 'tags' => '', 'postcount' => 9, 'offset' => 0, 'sticky' => 1);
        ...
        echo $args['before_widget'];
			if ($widget_posts->have_posts()) :
				...
				echo '<div class="owl-carousel blogpedia-slider-2">' . "\n";
					$i = 0;
    ...
    function form($instance) {
		...
		<div class="blogpedia-border">
			<img src="<?php echo get_template_directory_uri() . '/public/images/widget/slider-2.png'; ?>" alt="" />
		</div>
        <p>
