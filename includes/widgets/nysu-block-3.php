...
class blogpedia_block_3_widget extends WP_Widget {
   function __construct() {
		parent::__construct(
			'blogpedia_block_3', esc_html_x('BLOGPEDIA Block 3 - Mag (4/12)', 'widget name', 'blogpedia'),
			array(
				'classname' => 'blogpedia-block-3-widget',
				'description' => esc_html__('BLOGPEDIA Block 3 widget posts (vertical small)', 'blogpedia'),
    ...
    function form($instance) {
		...
		<div class="blogpedia-border">
			<img src="<?php echo get_template_directory_uri() . '/public/images/widget/block-3.png'; ?>" alt="" />
		</div>
        <p>
