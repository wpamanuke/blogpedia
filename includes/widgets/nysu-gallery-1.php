...
class blogpedia_gallery_1_widget extends WP_Widget {
   function __construct() {
		parent::__construct(
			'blogpedia_gallery_1', esc_html_x('BLOGPEDIA Gallery 1 - Mag (12/12)', 'widget name', 'blogpedia'),
			array(
				'classname' => 'blogpedia-gallery-1-widget',
				'description' => esc_html__('BLOGPEDIA Gallery 1 widget posts (4 in 1)', 'blogpedia'),
        ...
        echo $args['before_widget'];
			...
			if ($widget_posts->have_posts()) :
				...
				echo '<div class="blogpedia-normal-widget">' . "\n";
					$i = 0;
					//if ($i==1) { 
							echo '<div class="blogpedia-gallery-1">';
						
					//}
					while ($widget_posts->have_posts()) : $widget_posts->the_post();
						$i++;
						get_template_part( 'template-parts/block/gallery', '1' );
    ...
    function form($instance) {
		...
		<div class="blogpedia-border">
			<img src="<?php echo get_template_directory_uri() . '/public/images/widget/gallery-1.png'; ?>" alt="" />
		</div>
        <p>
