...
class blogpedia_block_2_widget extends WP_Widget {
   function __construct() {
		parent::__construct(
			'blogpedia_block_2', esc_html_x('BLOGPEDIA Block 2 - Mag (4/12)', 'widget name', 'blogpedia'),
			array(
				'classname' => 'blogpedia-block-2-widget',
				'description' => esc_html__('BLOGPEDIA Block 2 widget posts (vertical big)', 'blogpedia'),
				...
				echo '<div class="blogpedia-normal-widget">' . "\n";
					while ($widget_posts->have_posts()) : $widget_posts->the_post();
						...
						if ($i<$last) {
							...
							blogpedia_magazine_block_space();
						} else {
							get_template_part( 'template-parts/block/block', '2' );
						}
					endwhile;
    ...
    function form($instance) {
		...
		<div class="blogpedia-border">
			<img src="<?php echo get_template_directory_uri() . '/public/images/widget/block-2.png'; ?>" alt="" />
		</div>
        <p>
