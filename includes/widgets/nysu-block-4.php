...
class blogpedia_block_4_widget extends WP_Widget {
   function __construct() {
		parent::__construct(
			'blogpedia_block_4', esc_html_x('BLOGPEDIA Block 4 - Mag (4/12)', 'widget name', 'blogpedia'),
			array(
				'classname' => 'blogpedia-block-4-widget',
				'description' => esc_html__('BLOGPEDIA Block 4 widget posts (vertical big small)', 'blogpedia'),
        ...
        echo $args['before_widget'];
			if ($widget_posts->have_posts()) :
				...
				echo '<div class="blogpedia-normal-widget">' . "\n";
					$i = 0;
					echo '<div class="blogpedia-block-2">';
					while ($widget_posts->have_posts()) : $widget_posts->the_post();
						$i++;
						if ($i==1) { 
							get_template_part( 'template-parts/block/block', '4-1' );
						} else {
							get_template_part( 'template-parts/block/block', '4-2' );
						}
					endwhile;
					echo '</div>';
					wp_reset_postdata();
    ...
    function form($instance) {
		...
		<div class="blogpedia-border">
			<img src="<?php echo get_template_directory_uri() . '/public/images/widget/block-4.png'; ?>" alt="" />
		</div>
        <p>
