...
class blogpedia_slider_3_widget extends WP_Widget {
   function __construct() {
		parent::__construct(
			'blogpedia_slider_3', esc_html_x('BLOGPEDIA Slider 3 - Mag (12/12)', 'widget name', 'blogpedia'),
			array(
				'classname' => 'blogpedia-slider-3-widget',
				'description' => esc_html__('BLOGPEDIA Slider 3 widget posts (4 in 1) ', 'blogpedia'),
	...
	function widget($args, $instance) {
        ...
        echo $args['before_widget'];
			if ($widget_posts->have_posts()) :
				...
				echo '<div class="owl-carousel blogpedia-slider-3">' . "\n";
					$i = 0;
					while ($widget_posts->have_posts()) : $widget_posts->the_post();
						get_template_part( 'template-parts/block/slider', '3' );
					endwhile;
					wp_reset_postdata();
				echo '</div>' . "\n";
				echo '</div>' . "\n";
    ...
    function form($instance) {
		...
		<div class="blogpedia-border">
			<img src="<?php echo get_template_directory_uri() . '/public/images/widget/slider-3.png'; ?>" alt="" />
		</div>
        <p>
